...
namespace lve {
	...
	void FirstApp::createPipeline()
	{
		...
		lvePipeline = std::make_unique<LvePipeline>(lveDevice, "src/shaders/simple_shader.vert.spv", "src/shaders/simple_shader.frag.spv", pipelineConfig);
	}
